...
/**
 * Featured article for articles page
 * @type {Article}
 */
...
/**
 * Sidebar articles (shorter format)
 * @type {Article[]}
 */
...
// Home page blog preview articles (simpler format)
const HOME_BLOG_ARTICLES = [
    { 
        title: "איך לשפר את ריצת ה-2000 שלך ב-30 יום", 
        date: "12 SEP, 2023 // 14:00", 
        category: "אימונים", 
    ...
    { 
        title: "חוסן מנטלי: הנשק הסודי של הלוחם", 
        date: "05 SEP, 2023 // 09:30", 
        category: "מנטלי", 
        img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDh6qRR2L9qesEs67aGzOhSNt9CIpTWth5bInlbwHtKalSpiIZgkdH2l6O9yHYJj0yWjVqsN9q8ERIBY7eR6sM5MNdPb1Yy0eUZjuoSv6XHVrf7iCDXjP8mArNPn_WBYFSctCPQjTO0DYLGBvulICfH8LQ_8qoUIpihYjQ0xY5tnDy8HqJxE2Xz8KiLxjvOWH2j_XOYreHyp3MQgWJBL3If7wUOFxxkpGbWd0-FQtAtVo2-KafsaYuePD-tkgqPpFuO8JQ6sT46tGCF" 
    },
    { 
        title: "תזונה קרבית: מה לאכול לפני מסע כומתה", 
        date: "28 AUG, 2023 // 18:45", 
        category: "תזונה", 
        img: "https://lh3.googleusercontent.com/aida-public/AB6AXuADhMGx-tvGi_T_-YD3POECAz4v6VllY_85Y8Q2NN0Ql6iDQo3xyBpSq6hVG5vFkxXNYIvksh-GaXPbNkZPKRlFtl5aDNnOtBE45LQS-iLt3bhc2g25o5xcMMyjf3Vr5wX1uzfSdOaOScjrr4Y89Foc4BvQiTTEQ0SliEa2_jygsnyGzwnLmRTottRT0qDyO3mrrVso6PZketX-9EbdDlzbrMfTN0X3-UcbbK2Guli9uO1iPtnuK0lo0IzDD1q73YpqXncp0s1tOIAP" 
    }
];

// Export for use in browser (global variables)
